...
const RaspStyle rasp_styles[] = {
  ...
  { _T("ThermalStrength"), rasp_colors_thermalstrength, 4, false },
  { _T("ThermalHeight"), rasp_colors_thermalheight, 4, false },
  { _T("Convergence"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_1000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_2000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_3000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_4000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_5000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_6000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Wave_7000m"), rasp_colors_verticalspeed, 5, false },
  { _T("Temperature2m"), rasp_colors_temperature, 4, false },
  { _T("Rain"), rasp_colors_rain, 3, false },
  { _T("PFD_Day_DuoDiscus"), rasp_colors_pfd_ls4, 3, false },
  { _T("PFD_Day_LS4"), rasp_colors_pfd_ls4, 3, false },
  { _T("PFD_Day_K8"), rasp_colors_pfd_ls4, 3, false },
  { _T("Windspeed_10m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_1000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_1500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_2000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_2500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_3000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_3500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_4000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_4500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_5000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_5500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_6000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_6500m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("Windspeed_7000m"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("VerticalWindShear"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("BL_AverageWindSpeed"), rasp_colors_bl_avg_windspeed, 3, false },
  { _T("XCSpeed_LS4"), rasp_colors_xcspeed_ls4, 3, false },
  { _T("XCSpeed_DuoDiscus"), rasp_colors_xcspeed_ls4, 3, false },
  { _T("XCSpeed_K8"), rasp_colors_xcspeed_k8, 3, false },
  { _T("SurfaceHeatFlux"), rasp_colors_surface_heat_flux, 6, false },
  { _T("SeaLevelPressure"), rasp_colors_sealevel_pressure, 7, false },
  { _T("Cloudfraction_Low"), rasp_colors_cloudfraction_low, 4, false },
  { _T("Cloudfraction_Mid"), rasp_colors_cloudfraction_mid, 4, false },
  { _T("Cloudfraction_High"), rasp_colors_cloudfraction_high, 4, false },
  { _T("Cloudfraction_Accumulated"), rasp_colors_cloudfraction_accumulated, 4, false },
