...
#include "com_exadios_xcsoar_InternalGPS.h"
#include "com_exadios_xcsoar_NonGPSSensors.h"
...
InternalSensors::Initialise(JNIEnv *env)
{
  ...
  gps_cls.Find(env, "com/exadios/xcsoar/InternalGPS");

  gps_ctor_id = env->GetMethodID(gps_cls, "<init>",
                                 "(Landroid/content/Context;I)V");
  close_method = env->GetMethodID(gps_cls, "close", "()V");

  sensors_cls.Find(env, "com/exadios/xcsoar/NonGPSSensors");
...
Java_com_exadios_xcsoar_InternalGPS_setConnected(JNIEnv *env, jobject obj,
                                         jint connected)
{
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_com_exadios_xcsoar_InternalGPS_setLocation(JNIEnv *env, jobject obj,
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_com_exadios_xcsoar_NonGPSSensors_setAcceleration(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_com_exadios_xcsoar_NonGPSSensors_setRotation(
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_com_exadios_xcsoar_NonGPSSensors_setMagneticField(
...
/**
 * Helper function for
 * Java_com_exadios_xcsoar_NonGPSSensors_setBarometricPressure: Given a
...
gcc_visibility_default
JNIEXPORT void JNICALL
Java_com_exadios_xcsoar_NonGPSSensors_setBarometricPressure(
