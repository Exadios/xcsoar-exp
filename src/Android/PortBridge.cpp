...
{
  Java::Class cls(env, "au/org/narroginglidingclub/xcsoar/AndroidPort");

  setListener_method = env->GetMethodID(cls, "setListener",
                                        "(Lau/org/narroginglidingclub/xcsoar/PortListener;)V");
  setInputListener_method = env->GetMethodID(cls, "setInputListener",
                                             "(Lau/org/narroginglidingclub/xcsoar/InputListener;)V");
