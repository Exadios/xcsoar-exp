...
#include "com_exadios_xcsoar_NativePortListener.h"
...
Java_com_exadios_xcsoar_NativePortListener_portStateChanged(JNIEnv *env,
                                                            jobject obj)
{
...
{
  cls.Find(env, "com/exadios/xcsoar/NativePortListener");
