...
{
  i2cbaro_class.Find(env, "au/org/narroginglidingclub/xcsoar/GlueI2Cbaro");

  i2cbaro_ctor = env->GetMethodID(i2cbaro_class, "<init>",
                                 "(Lau/org/narroginglidingclub/xcsoar/IOIOConnectionHolder;IIIIILau/org/narroginglidingclub/xcsoar/SensorListener;)V");
}
