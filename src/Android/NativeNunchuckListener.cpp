...
#include "org_narroginglidingclub_xcsoar_NativeNunchuckListener.h"
...
Java_org_narroginglidingclub_xcsoar_NativeNunchuckListener_onNunchuckValues(JNIEnv *env,
                                                                jobject obj,
                                                                jint joy_x,
                                                                jint joy_y,
                                                                jint acc_x,
...
JNIEXPORT void JNICALL
Java_org_narroginglidingclub_xcsoar_NativeNunchuckListener_onNunchuckError(JNIEnv *env,
                                                               jobject obj)
{
  jlong ptr = env->GetLongField(obj, NativeNunchuckListener::ptr_field);
  if (ptr == 0)
...
{
  cls.Find(env, "org/narroginglidingclub/xcsoar/NativeNunchuckListener");
