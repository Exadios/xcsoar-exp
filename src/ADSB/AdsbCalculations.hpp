...
class AdsbCalculations
  {
private:
  typedef std::map<IcaoId, ClimbAverageCalculator> AverageCalculatorMap;
  AverageCalculatorMap averageCalculatorMap;

public:
  double Average30s(IcaoId id, double curTime, double curAltitude);
