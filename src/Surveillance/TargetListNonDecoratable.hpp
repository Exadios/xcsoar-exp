...
public:
   ...
   *
   * \todo This is ugly. Find a more elegent way to do this!
   */
  enum TargetType
    {
    MIXED,	// Mixed (or unknown) target types in \ref traffic.
    FLARM,	// All targets in \ref traffic are FLARM.
    ADSB,	// All targets in \ref traffic are ADSB.
    }
  type;
