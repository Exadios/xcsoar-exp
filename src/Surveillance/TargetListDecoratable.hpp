...
#include "Surveillance/TrivialArrayDecorator.hpp"
 ...
 */
struct TargetListDecoratable : public TargetListBase
  {
public:
   ...
   */
  TargetListDecoratable(const TargetListDecoratable& src) = delete;
   ...
   * @return This object.
   */
  TargetListDecoratable& operator=(const TargetListDecoratable& rhs);
  ...
  /** Target information */
  TrivialArrayDecorator<std::shared_ptr<RemoteTarget>, MAX_COUNT> list;
//  std::list<std::shared_ptr<RemoteTarget>> list;
  ...
  /* constexpr */ void Complement(const TargetListDecoratable &add)
    {
   ...
   *         List variable;
   */
  virtual TrivialArrayDecorator< std::shared_ptr< RemoteTarget >, MAX_COUNT >* List()
    {
    return &this->list;
    }
   ...
   *         List variable;
   */
  virtual const TrivialArrayDecorator< std::shared_ptr< RemoteTarget >, MAX_COUNT >* List() const
    {
    return &this->list;
    }
 ...
 *\} 
 */
//static_assert(std::is_trivial<TargetListDecoratable>::value, "type is not trivial");
