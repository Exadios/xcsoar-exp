...
AAPT = $(ANDROID_BUILD_TOOLS_DIR)/aapt2
...
JAVA_PACKAGE = com.exadios.xcsoar
...
$(ANDROID_BUILD)/gen/com/exadios/xcsoar/R.java: $(ANDROID_BUILD)/resources.apk

$(ANDROID_BUILD)/classes.dex: $(JAVA_SOURCES) $(ANDROID_BUILD)/gen/com/exadios/xcsoar/R.java | $(JAVA_CLASSFILES_DIR)/dirstamp
	@$(NQ)echo "  JAVAC   $(JAVA_CLASSFILES_DIR)"
	$(Q)$(JAVAC) -source 1.6 -target 1.6 -Xlint:-options \
		-cp $(ANDROID_SDK_PLATFORM_DIR)/android.jar:$(JAVA_CLASSFILES_DIR) \
		-d $(JAVA_CLASSFILES_DIR) $(ANDROID_BUILD)/gen/com/exadios/xcsoar/R.java \
		$(JAVA_SOURCES)
	@$(NQ)echo "  DX      $@"
