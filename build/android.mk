...
JAVA_PACKAGE = au.org.narroginglidingclub.xcsoar
...
$(GEN_DIR)/au/org/narroginglidingclub/xcsoar/R.java: $(ANDROID_OUTPUT_DIR)/resources.apk

$(ANDROID_OUTPUT_DIR)/classes.dex: $(JAVA_SOURCES) $(GEN_DIR)/au/org/narroginglidingclub/xcsoar/R.java | $(JAVA_CLASSFILES_DIR)/dirstamp
	...
	$(Q)$(JAVAC) \
		...
		-d $(JAVA_CLASSFILES_DIR) $(GEN_DIR)/au/org/narroginglidingclub/xcsoar/R.java \
		-h $(NATIVE_INCLUDE) \
		$(JAVA_SOURCES)
	@$(NQ)echo "  DX      $@"
...
# build libxcsoar.so
$$(TARGET_OUTPUT_DIR)/$(2)/$$(XCSOAR_ABI)/bin/lib$(1).so: $(NATIVE_HEADERS) $(HOST_OUTPUT_DIR)/tools/GenerateSineTables$(HOST_EXEEXT) boost FORCE
