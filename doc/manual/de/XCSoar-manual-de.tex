...
%
% mal die Helvetika wählen zwecks besserer Onlinelesbarkeit..
\usepackage{helvet}
...
%%%%%%%%%%%%%%%%%%%%%%
\input{installation.tex}%									95%
%%%%%%%%%%%%%%%%%%%%%%
\input{ch02_user_interface.tex}%							95%
%%%%%%%%%%%%%%%%%%%%%%
\input{ch03_navigation.tex}%								99%
%%%%%%%%%%%%%%%%%%%%%%
...
%%%%%%%%%%%%%%%%%%%%%%
\input{ch08_avionics_and_airframe.tex}%					 99%
%%%%%%%%%%%%%%%%%%%%%%
