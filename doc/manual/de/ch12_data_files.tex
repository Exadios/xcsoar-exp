...
\achtung {\sl Es ist sicherzustellen, daß keinerlei Leerzeichen in den Filenamen nach dem \verb|image=|
auftauchen!!!}
...
\section{Checklist}\index{File-Format!Checkliste}
...
Diese werden durch doppelte \todonum{im Beispiel sind es nur einfache Leerzeichen..??}
