...
\includegraphics[width=0.8cm]{icons/map_obstacle.pdf} &
\includegraphics[width=0.8cm]{icons/map_pass.pdf} &
\includegraphics[width=0.8cm]{icons/map_power_plant.pdf} &
\includegraphics[width=0.8cm]{icons/map_tower.pdf} &
\includegraphics[width=0.8cm]{icons/map_tunnel.pdf} &
\includegraphics[width=0.8cm]{icons/map_weather_station.pdf}\\
\hline
\end{tabular}
\end{center}
