...
Config 1
 & \bmenut{MacCready}{$+$}
 & \ref{sec:stf}\bmenut{MacCready}{$-$}
 & \ref{sec:auto-maccready}\bmenut{MacCready}{Auto}
 & \ref{sec:flight-setup}\bmenus{Flight}
 & \ref{sec:wind-setup}\bmenus{Wind} \\ \\
Config 2
 & \ref{cha:configuration}\bmenus{System}
 & \bmenus{Plane}
...
Config 3
 ...
 & \ref{sec:raw-logger}\bmenus{Raw Logger}
 & \ref{sec:airspace-filter}\bmenus{Airspace}
 & {}
 & \bmenus{Vega}
\end{tabularx}}
...
\begin{tabularx}{1.8\textwidth}{l|ccccc}
Info 1 &
 \ref{sec:flarm-traffic}\bmenut{FLARM}{Radar}
 & \bmenut{METAR}{TAF}
 & \bmenut{What's}{here?}
 & \ref{sec:checklist}\bmenut{Check}{list}
 & \ref{sec:analysis-climb}\bmenus{Analysis} \\ \\
Info 2
 & \ref{sec:flight-status}\bmenus{Status}
...
Info 3
 & \ref{sec:credits}\bmenus{Credits}
 & {}
 & {}
 & {}
...
Pan
 & \ref{sec:panning}\bmenut{Pan}{Off}
 & \bmenut{Zoom}{in}
 & \bmenut{Zoom}{out}
 & \bmenut{What's}{here?}
\end{tabularx}}
