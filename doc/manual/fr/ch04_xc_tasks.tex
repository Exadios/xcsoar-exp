...
\item
Depuis \bmenu{Info.}\blink\bmenu{Qu'y a-t-il ici?} pour afficher la liste des éléments qui se trouvent sous le curseur ou sous votre doigt sur la carte.
...
\item depuis l'éditeur de circuits,  \bmenu{Nav ..}\blink\bmenu{Circuit} et "Général" et créer un nouveau circuit et ajouter un point de virage.
