...
\begin{enumerate}
\item Le menu \bmenu{Info ..}\blink\bmenu{Etats}vous permet de voir entre autre le temps de vol.
\item Le menu \bmenu{Info ..}\blink\bmenu{Analyses}vous permet d'analyser votre vol ou de le revoir.
