...
La traduction des chapitres "Installation" et "User Interface" n'est pas encore faite. Cependant vous pouvez télécharger le manuel "Prise en main du logiciel" écrit par Adrien Ott afin d'avoir une vue rapide du logiciel et de son installation.
Ce manuel est en ligne sur le site XCSoar : {\href{http://download.xcsoar.org/releases/6.4.5/XCSoar-Prise-en-main.pdf}{http://download.xcsoar.org/releases/6.4.5/XCSoar-Prise-en-main.pdf}}
...
\bmenu{Systèm}.  The Configuration screen should be displayed:
